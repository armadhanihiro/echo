import { CheckCircle2, Gauge, ShieldCheck, Timer, Truck } from "lucide-react";
    ...
    <section className="rounded-2xl border border-slate-800 bg-[#131C2E] p-6">
      <div className="flex items-start justify-between">
        ...
        <span className="rounded-full border border-emerald-500/30 bg-emerald-500/15 px-3 py-1 text-xs font-semibold text-emerald-300">
          {isSimulationRunning ? "Decision Ready" : "Waiting"}
        </span>
      </div>
      ...
      <div className="mt-5 grid grid-cols-[1.1fr_0.9fr] gap-5">
        ...
        <div className="rounded-2xl border border-slate-800 bg-[#0B1220] p-5">
          <p className="text-sm font-semibold text-white">Decision Evidence</p>

          <div className="mt-4 space-y-3 text-sm text-slate-300">
            <div className="flex gap-3">
              <ShieldCheck size={18} className="mt-0.5 text-emerald-300" />
              <span>Lowest casualty risk across simulated scenarios.</span>
            </div>

            <div className="flex gap-3">
              <Timer size={18} className="mt-0.5 text-cyan-300" />
              <span>Evacuation can be completed within the safe weather window.</span>
            </div>

            <div className="flex gap-3">
              <Truck size={18} className="mt-0.5 text-blue-300" />
              <span>Required resources are available within current capacity.</span>
            </div>

            <div className="flex gap-3">
              <Gauge size={18} className="mt-0.5 text-amber-300" />
              <span>Operational risk remains manageable under current conditions.</span>
            </div>
          </div>
          ...
          <div className="mt-5 rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-4">
            ...
            <p className="mt-2 text-sm text-slate-300">
              Evacuate Zone B first, deploy 18 response units, and keep medical
              teams on standby for the next 45 minutes.
            </p>
          </div>
        </div>
      </div>
